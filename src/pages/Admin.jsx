...
import OrderList from '../components/admin/OrderList';
    ...
    // PlaceHolder components - will be implmented in the next steps
...
const Admin = () => {
    ...
    //protected Route only admin can access to it
  ...
  return (
    <Box sx={{display: 'flex'}}>
        <AppBar position="fixed" sx={{zIndex: (theme) => theme.zIndex.drawer + 1}}>
            <Toolbar>
                <Typography variant="h6" noWrap component= "div" sx={{flexGrow: 1 }}>Fashion Fuel Admin</Typography>
